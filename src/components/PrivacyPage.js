    ...
    <div>
      <Paper className={classes.root} elevation={1}>
        ...
        <Typography component="p">
          ...
          <p>
            Instagram Profile Searcher ("us", "we", or "our") operates the
            http://orlandodiaz.io website (the "Service").
          </p>
          ...
          <p>
            ...
            Instagram Profile Searcher is managed through{" "}
          ...
          <p>
            Instagram Profile Searcher uses the collected data for various
            purposes:
          </p>
          <ul>
          ...
          <p>
            Instagram Profile Searcher will take all steps reasonably necessary
          ...
          <p>
            Instagram Profile Searcher may disclose your Personal Data in the
            good faith belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Instagram Profile
              Searcher
            </li>
            <li>
          ...
          <ul>
            <li>By email: orlandodiaz@dev.gmail.com</li>
          </ul>
        </Typography>
      </Paper>
    </div>
